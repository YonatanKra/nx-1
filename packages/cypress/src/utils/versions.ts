...
/**
 * this is only the mac version, and temp until there is a v10 release
 */
export const cypressVersion =
  'https://cdn.cypress.io/beta/npm/10.0.0/darwin-x64/circle-10.0-release-9f624b4f7a2cfbae4e7a69a0b2036642a3945c2c/cypress.tgz';
